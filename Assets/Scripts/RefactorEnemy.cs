...
public class RefactorEnemy : MonoBehaviour
{
   [SerializeField] private Stats enemyStats;
    ...
    [SerializeField] private GameObject enemyExplosionParticles;
    ...
    private void Update()
    {
        ...
        if (enemyStats.idle == true)
        {
            ...
            transform.position =
                Vector3.MoveTowards(transform.position, moveToPoint, enemyStats.walkSpeed * Time.deltaTime);
    ...
    private void OnCollisionEnter(Collision other)
        {
            //Checks if player is on the slipping object layer
